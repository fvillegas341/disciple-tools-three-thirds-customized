...
class DT_33_Transformers
{
    ...
    /**
     * Format a list of group members for the front-end
     * @return mixed
     */
    public function members($members, $with = [])
    {
        return $this->transform_posts($members, 'member', $with);
    }

    /**
     * Format a single group member for the front-end
     * @return mixed
     */
    public function member($member, $with = [])
    {
        return [
            'value' => $member['ID'],
