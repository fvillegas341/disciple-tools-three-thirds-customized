<?php
/**
 * Plugin Name: Disciple.Tools - 3/3rds Meetings Customized
...
if (!function_exists('disciple_tools_three_thirds_hook_admin_notice')) {
    function disciple_tools_three_thirds_hook_admin_notice()
    {
        ...
        $message = "'Disciple.Tools - 3/3rds Meetings Customized' plugin requires 'Disciple.Tools' theme to work. Please activate 'Disciple.Tools' theme or make sure it is latest version.";
